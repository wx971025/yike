...
export default function WordReviewSettingsMenu({
  ...
  return (
    <div ref={menuRef} className="relative">
      {open && (
        <div className="absolute right-0 top-full z-30 mt-2 w-64 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900">
